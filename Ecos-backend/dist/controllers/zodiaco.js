    ...
    constructor() {
        ...
        this.chatWithAstrologer = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.log(`📊 Sternzeichen - Nachrichtenanzahl: ${messageCount}, Premium: ${isPremiumUser}, Vollständige Antwort: ${shouldGiveFullResponse}, Erste Nachricht: ${isFirstMessage}`);
...
Antwort der Astrologin (AUF DEUTSCH, ${isFirstMessage
                ...
                console.log(`Erstelle Sternzeichen-Lesung (${shouldGiveFullResponse ? "VOLLSTÄNDIG" : "TEASER"})...`);
                let text = "";
                let usedModel = "";
                let allModelErrors = [];
                ...
                console.log(`✅ Sternzeichen-Lesung erstellt (${shouldGiveFullResponse ? "VOLLSTÄNDIG" : "TEASER"}) mit ${usedModel} (${finalResponse.length} Zeichen)`);
            ...
            try {
                res.json({
                    ...
                    astrologer: {
                        ...
                        description: "Expertin für die Interpretation der Eigenschaften und Energien der zwölf Tierkreiszeichen",
                        services: [
...
- Mit Sternzeichen: ${isFullResponse
...
Denk dran: ${isFirstMessage
            ...
            : "⚠️ DAS IST EIN LAUFENDES GESPRÄCH - NICHT GRÜSSEN, geh direkt zum Inhalt. Der Nutzer weiß schon, wer du bist."} Du bist eine Sternzeichen-Expertin, die ${isFullResponse
            ? "die astrologischen Eigenschaften verständlich und vollständig interpretiert"
            : "über die besonderen Eigenschaften fasziniert, die sie im Sternzeichen erkannt hat"}. FRAGE immer nach dem Sternzeichen oder Geburtsdatum, wenn du es nicht hast.`;
    }
