...
✨ *Tausende Menschen haben ihr Leben bereits mit der Führung der Sterne verändert...*`;
  ...
  public chatWithMaster = async (
    ...
    try {
      ...
      console.log(
        `📊 Horoskop - Nachrichtenanzahl: ${messageCount}, Premium: ${isPremiumUser}, Vollständige Antwort: ${shouldGiveFullResponse}, Erste Nachricht: ${isFirstMessage}`
      );
...
Denk dran: ${
    ...
    } Du bist eine weise Astrologin, die ${
      isFullResponse
        ? "die vollständige Weisheit der Sterne enthüllt"
        : "über die himmlischen Botschaften fasziniert, die sie erkannt hat"
    }. Sprich wie eine weise Freundin, die wirklich das Geburtsdatum wissen möchte, um die Sternenweisheit zu teilen.`;
  }
    ...
    try {
      res.json({
        ...
        master: {
          ...
          description:
            "Weise Astrologin, spezialisiert auf die Interpretation der himmlischen Einflüsse und die Weisheit der zwölf Sternzeichen",
          services: [
